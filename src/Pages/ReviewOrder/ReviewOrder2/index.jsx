...
import Line20 from "../../../assets/svg/Line 20.svg";
...
const ReviewOrder2 = () => {
  ...
  return (
    <div className="revieworder2">
      ...
      <img className="line4" src={Line20}></img>
      <button className="payandpickup">Pay and Pick up</button>
      <button className="storebutt">I’ll buy it from Store</button>
